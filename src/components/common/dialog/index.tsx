...
import {
  Modal, Pressable, StyleSheet, View, TouchableWithoutFeedback, PressableProps,
} from "react-native";
import Animated, {
  useAnimatedProps, useAnimatedStyle, useSharedValue, withTiming, interpolate, Easing, Extrapolation, LinearTransition, withSpring,
} from "react-native-reanimated";
import { BlurView } from "expo-blur";
import type {
  DialogCloseProps, DialogComponent, DialogProps, DialogTriggerProps, DialogBackdropProps, ExtendedDialogContextType, ExtendedDialogContentProps,
} from "./types";
  ...
  return (
    <DialogContext.Provider value={contextValue}>
      {React.Children.map(children, (child) => {
        if (React.isValidElement<ExtendedDialogContentProps>(child) && child.type === DialogContent) {
            return React.cloneElement<ExtendedDialogContentProps>(child, {
            isAnimating,
            setIsAnimating,
            });
        }
