...
export default function Profile() {
  ...
  const stats = [
    { label: 'Entregas', value: '30', color: '#2D60FF' },
    { label: 'Concluídas', value: '27', color: '#10B981' },
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={() => openEdit('nome', userData.nome)}>
        ...
        >
          ...
          >
            {activeField && (
              <>
                {/* Ícone no topo da sheet */}
                <View style={styles.sheetIconWrap}>
                  <Ionicons name="create" size={22} color="#2D60FF" />
                </View>
